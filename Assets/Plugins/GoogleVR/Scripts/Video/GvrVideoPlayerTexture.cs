...
public class GvrVideoPlayerTexture : MonoBehaviour {
    ...
    public bool VideoReady {
        get { return videoPlayerPtr != IntPtr.Zero && IsVideoReady(videoPlayerPtr); }
    }
    ...
    public long CurrentPosition {
        get { return videoPlayerPtr != IntPtr.Zero ? GetCurrentPosition(videoPlayerPtr) : 0; }
    ...
    public VideoPlayerState PlayerState {
        get {
            return videoPlayerPtr != IntPtr.Zero
                ? (VideoPlayerState) GetPlayerState(videoPlayerPtr)
    ...
    public StereoMode CurrentStereoMode {
        get { return videoPlayerPtr != IntPtr.Zero ? (StereoMode) GetStereoMode(videoPlayerPtr) : StereoMode.NoValue; }
    }
    ...
    private void CreatePlayer() {
        ...
        SetOnExceptionCallback((type, msg) => { Debug.LogError("Exception: " + type + ": " + msg); });
