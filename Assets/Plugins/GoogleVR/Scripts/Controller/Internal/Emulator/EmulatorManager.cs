...
namespace Gvr.Internal {
    class EmulatorManager : MonoBehaviour {
        ...
        public event OnGyroEvent gyroEventListeners {
            ...
            remove { gyroEventListenersInternal -= value; }
        }
        ...
        public event OnAccelEvent accelEventListeners {
            ...
            remove { accelEventListenersInternal -= value; }
        }
        ...
        public event OnTouchEvent touchEventListeners {
            ...
            remove { touchEventListenersInternal -= value; }
        }
        ...
        public event OnOrientationEvent orientationEventListeners {
            ...
            remove { orientationEventListenersInternal -= value; }
        }
        ...
        public event OnButtonEvent buttonEventListeners {
            ...
            remove { buttonEventListenersInternal -= value; }
        }
        ...
        public bool Connected {
            get { return socket != null && socket.connected == EmulatorClientSocketConnectionState.Connected; }
        }

        public bool Connecting {
            get { return socket != null && socket.connected == EmulatorClientSocketConnectionState.Connecting; }
        }
