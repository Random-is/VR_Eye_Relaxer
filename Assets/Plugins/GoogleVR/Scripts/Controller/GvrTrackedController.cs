...
public class GvrTrackedController : MonoBehaviour {
    ...
    [SerializeField] [Tooltip("Is the object's active status determined by the controller connection status.")]
    private bool isDeactivatedWhenDisconnected = true;

    [SerializeField] [Tooltip("Controller Hand")]
    ...
    public GvrControllerInputDevice ControllerInputDevice {
        get { return controllerInputDevice; }
    }
    ...
    public bool IsDeactivatedWhenDisconnected {
        get { return isDeactivatedWhenDisconnected; }
