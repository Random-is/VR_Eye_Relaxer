...
public class GvrArmModel : GvrBaseArmModel, IGvrControllerInputDeviceReceiver {
    ...
    [Range(0.0f, 1.0f)] public float elbowBendRatio = DEFAULT_ELBOW_BEND_RATIO;
    ...
    /// </remarks>
    [Range(0, 180)] public int tooltipMaxAngleFromCamera = 80;
